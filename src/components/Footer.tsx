export default function Footer() {
  return (
    <div className="relative z-10 bottom-0">
      {/*  Display on Desktop */}
      <div
        className={`lg:flex hidden font-semibold py-20 lg:py-5 bg-white w-full h-16 text-black flex-col gap-4 lg:flex-row lg:justify-around justify-center items-center`}
      >
      ...
      {/*  Display on Mobile */}
      <div
        className={`lg:hidden flex font-semibold py-20 bg-white w-full h-16 text-black flex-col gap-4  justify-center items-center`}
      >
