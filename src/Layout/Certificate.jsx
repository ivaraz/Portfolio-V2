export default function Certificate() {
  return (
    ...
    >
      ...
      <div
        data-aos="fade-up"
        className="group w-fit max-w-[24rem] h-fit p-5 border-2 border-black"
      >
        <img src="/assets/certificate/sertif.jpg" className="w-96"></img>
        <p className="text-center font-semibold">
          October Digital Creativity 2023
        </p>
        <i className="text-gray-600 hidden group-hover:block group-hover:duration-1000">
